...
class GameItem extends StatefulWidget {
  ...
  GameItem(
      this.gameTitle, this.gameImage, this._AlphabetState);
            ...
            children: <Widget>[
              ...
              Row(
                children: <Widget>[
                  ...
                  Expanded(
                      child: Text(
                        completeLast?"Completed":_start.toString(),
                        style: TextStyle(color:completeLast?Colors.green:Colors.indigo, fontSize: 16.0),
                      )),
                  Expanded(
                      child: Text("Animal",
                          style:
                ...
                Row(
                  children: <Widget>[
                    ...
                    Expanded(
                        child: Text(
                          completeLast?"Completed":_start.toString(),
                          style: TextStyle(color:completeLast?Colors.green: Colors.white, fontSize: 16.0),
                        )),
                    Expanded(
                        child: Text("Animal",
                            style: TextStyle(
